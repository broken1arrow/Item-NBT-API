...
public final class CompMetadata {
	 ...
	 * <p>
	 * Use {@link #setMetadata(org.bukkit.entity.Entity, String)} to set persistent custom tags for entities.
	 *
	 ...
	 * <p>
	 * Only usable if you set it using the {@link #setTempMetadata(org.bukkit.entity.Entity, String, Object)} with the key parameter
	...
	private static String getNamedspaced(final TileState tile, final String key) {
		final String value = tile.getPersistentDataContainer().get(new NamespacedKey(plugin, key), PersistentDataType.STRING);
	...
	/**
	 * Return true if the given tile entity block such as {@link org.bukkit.block.CreatureSpawner} has
	 * the given key
	 *
