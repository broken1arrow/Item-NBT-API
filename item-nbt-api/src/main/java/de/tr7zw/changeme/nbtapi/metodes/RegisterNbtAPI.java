...
public class RegisterNbtAPI {
	...
	/**
	 * work in progress. Will later fix this so you can save data (is optional method to tr7zw file saving)
	 */
	...
	/**
	 * Get methods to easy set metadata.
	 * If you want to set up self you can start
	 * with this classes {@link de.tr7zw.changeme.nbtapi.NBTItem} and {@link de.tr7zw.changeme.nbtapi.NBTEntity}
	 *
